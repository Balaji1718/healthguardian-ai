...
export const Route = createFileRoute("/app")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track daily health, verify medical reports and review preventive health patterns." },
...
function AppLayout() {
  ...
  useEffect(() => {
    if (!loading && !user && isFirebaseConfigured) void navigate({ to: "/auth", replace: true });
